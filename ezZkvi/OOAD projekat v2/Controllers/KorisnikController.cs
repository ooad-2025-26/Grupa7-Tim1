...
namespace ezZkvi.Controllers
{
    public class KorisnikController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Username,Email,Lozinka")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Username,Email,Lozinka")] Korisnik korisnik)
        {
            if (id != korisnik.ID)
            {
                return NotFound();
